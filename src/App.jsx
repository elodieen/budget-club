  ...
  return (
    <>
      ...
      <div style={{ flex:1, overflowY:'auto', padding:'0 16px', paddingBottom:'calc(80px + env(safe-area-inset-bottom))', background:C.beige }}>
        ...
        {/* Clôture du mois */}
        <div ref={closeRef} style={{ paddingTop:12 }}>
          {m.closed ? (
...
export function RevenusView({ m, mi, setMi, updateData, onProfileAction }) {
  ...
  return (
    <>
      ...
      <div style={{ textAlign:'center', padding:'4px 16px 8px', fontFamily:serif, fontSize:12, fontStyle:'italic', color:C.muted, flexShrink:0, background:C.beige }}>Ce n'est pas ce qu'on gagne qui compte, c'est ce qu'on en fait.</div>
      {/* Total fixe en haut */}
...
export function DepensesView({ m, mi, setMi, updateData, depTab, setDepTab, onProfileAction }) {
  ...
  return (
    <>
      ...
      <div style={{ textAlign:'center', padding:'4px 16px 8px', fontFamily:serif, fontSize:12, fontStyle:'italic', color:C.muted, flexShrink:0, background:C.beige }}>Le luxe, c'est de ne jamais être surpris par ses comptes.</div>
      {/* Switcher capsule */}
