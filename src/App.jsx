...
const initProfiles = () => {
  ...
  if (!profiles) {
    profiles = [{ id:'elodie', name:'Elodie' }];
...
export function EpargneView({ currentYear, onProfileAction, isSupabaseBacked, saveStatus }) {
  ...
  return (
    <>
      ...
      <div style={{ padding:'16px 28px 4px', background:C.beige, flexShrink:0 }}>
        <div style={{ fontFamily:serif, fontSize:20, fontWeight:700, color:'#1E3328', textTransform:'uppercase', letterSpacing:'0.05em', textAlign:'left', lineHeight:1.2 }}>Épargne &amp;<br />Investissement</div>
